...
export default function ProviderRegisterPage() {
  ...
  const [existingUser, setExistingUser] = useState<{name?:string;email?:string;phone?:string}|null>(null);
  ...
  const renderStep = () => {
    if (!isLoggedIn) {
      // New user: 5 steps (0=Personal, 1=KYC, 2=Skills, 3=Bank, 4=Schedule)
      switch (step) {
        case 0:
          return (
      ...
      // Existing user: 4 steps (0=KYC, 1=Skills, 2=Bank, 3=Schedule)
      switch (step) {
        case 0: return (
          <div className="space-y-3">
