...
router.post('/email-otp/send', otpSendLimiter, auth.sendEmailOtp);
router.post('/email-otp/verify', otpVerifyLimiter, auth.verifyEmailOtp);
router.post('/resend-email-otp', otpSendLimiter, auth.resendEmailOtp);
